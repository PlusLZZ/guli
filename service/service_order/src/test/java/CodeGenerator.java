...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\IdeaProject\\谷粒学院学习项目\\guli_parent\\service\\service_order" + "/src/main/java");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return "D:\\IdeaProject\\谷粒学院学习项目\\guli_parent\\service\\service_order" + "/src/main/resources/mapper/" + pc.getModuleName()
        ...
        */
        ...
        strategy.setInclude(scanner("t_order,t_pay_log").split(","));
