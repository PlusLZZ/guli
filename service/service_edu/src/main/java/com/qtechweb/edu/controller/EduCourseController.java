...
import com.qtechweb.edu.service.impl.EduCourseDescriptionServiceImpl;
...
public class EduCourseController {
    ...
    public Result publish(@PathVariable("id") String id) {
        ...
        AssertUtils.BooleanIsTrue(courseService.updateById(eduCourse), "课程发布失败");
    ...
    public Result delete(@PathVariable("id") String id) {
        AssertUtils.BooleanIsTrue(courseService.removeById(id), "删除失败");
        return Result.success();
    }
}
