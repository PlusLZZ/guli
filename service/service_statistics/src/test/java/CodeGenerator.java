...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\IdeaProject\\谷粒学院学习项目\\guli_parent\\service\\service_statistics" + "/src/main/java");
        ...
        pc.setModuleName(scanner("statistics"));
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return "D:\\IdeaProject\\谷粒学院学习项目\\guli_parent\\service\\service_statistics" + "/src/main/resources/mapper/" + pc.getModuleName()
        ...
        */
        ...
        strategy.setNaming(NamingStrategy.underline_to_camel);//命名策略
        ...
        strategy.setInclude(scanner("statistics_daily").split(","));
